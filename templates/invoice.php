...
<table class="order-data-addresses">
	<tr>
        ...
        <?php if($this->settings['invoice_shipping_billing_layout'] == "shipping-billing"){ ?>
			...
			<h3><?php echo apply_filters('xc_woo_cloud_print_invoice_shipping_address', __( 'Ship To:', XC_WOO_CLOUD )); ?></h3>
        ...
        <td class="address billing-address">
			<h3><?php echo apply_filters('xc_woo_cloud_print_invoice_billing_address',__( 'Billing Address:', XC_WOO_CLOUD )); ?></h3>
	  ...
	  ?>
        ...
        <table class="order-data-table">
				...
				<tr class="delivery-date">
					<th><h3><?php _e( 'Delivery Date:', XC_WOO_CLOUD ); ?></h3></th>
					<td><h3><?php $this->delivery_date(); ?></h3></td>
				</tr>
...
<table class="order-details">
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'xc_woo_cloud_print_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?> <?php echo ($count%2 == 0)?"even":"odd";?> <?php echo (in_array($this->settings['size'],array("A6","A7","A8")))?"no-bottom-border":"";?>">
			<td class="product">
	...
	<tfoot>
    <?php if(in_array($this->settings['size'],array("A8"))){ $fcolspan="3"; }else{ $fcolspan = ''; } ?>
		<tr class="no-borders">
