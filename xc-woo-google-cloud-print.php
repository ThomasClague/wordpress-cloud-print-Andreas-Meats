...
if (!defined('XC_WOO_CLOUD_VERSION'))
    define('XC_WOO_CLOUD_VERSION', '3.1');
    ...
    final class XC_WOO_CLOUD
    {
        ...
        */
		...
		function xc_order_processed( $order_id, $posted_data, $order ){
			...
			if(in_array($payment_method,$print_order_upon_processed_methods) || in_array($payment_method, array_keys($print_order_upon_processed_methods))) {
